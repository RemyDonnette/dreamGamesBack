...
class RegistrationController extends AbstractController
{
    ...
    public function register(Request $request): JsonResponse
    {
        ...
        $email = (new Email())
            ...
            ->html(sprintf('Cliquez sur le lien suivant pour confirmer votre inscription : <a href="http://localhost:3000/confirmEmail/%s">Confirmer mon email</a>', $user->getConfirmationToken()));
